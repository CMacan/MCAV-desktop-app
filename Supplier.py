...
class Ui_Supplier(object):
    ...
    def setupUi(self, Supplier):
        ...
        sizePolicy.setHeightForWidth(Supplier.sizePolicy().hasHeightForWidth())
        Supplier.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(10)
        Supplier.setFont(font)
        Supplier.setStyleSheet("background-color: white;")
...
"")
        ...
        self.Order.clicked.connect(Supplier.close)
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setWeight(75)
...
"background-color: #CD2E2E;")
        ...
        self.Profile.clicked.connect(Supplier.close)
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setWeight(75)
...
"")
    ...
    def retranslateUi(self, Supplier):
        ...
        Supplier.setWindowTitle(_translate("Supplier", "MainWindow"))
        self.tarp.setText(_translate("Supplier", "TARPAULIN PRINTING SERVICES"))
        ...
        item.setText(_translate("Supplier", "Phone"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Supplier", "Country"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Supplier", "Address"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Supplier", "Action"))
import font_rc
import images_rc
