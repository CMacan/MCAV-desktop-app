...
# Form implementation generated from reading ui file 'AdminSupplierPage.ui'
#
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ProductLabel.setText(_translate("MainWindow", "Supplier List"))
        self.manageLabel.setText(_translate("MainWindow", "Manage your suppliers"))
        self.AddProduct.setText(_translate("MainWindow", "Back to Purchase"))
        self.Search.setText(_translate("MainWindow", "Search"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Supplier Name"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Supplier Code"))
