...
class Ui_Report_2(object):
    ...
    def setupUi(self, Report_2):
        ...
        sizePolicy.setHeightForWidth(Report_2.sizePolicy().hasHeightForWidth())
        Report_2.setSizePolicy(sizePolicy)
        Report_2.setStyleSheet("background-color: white;")
        self.centralwidget = QtWidgets.QWidget(Report_2)
...
"")
        ...
        self.tarp.clicked.connect(Report_2.close)
...
"width: 100vw;")
    ...
    def retranslateUi(self, Report_2):
        _translate = QtCore.QCoreApplication.translate
        Report_2.setWindowTitle(_translate("Report_2", "MainWindow"))
        self.tarp.setText(_translate("Report_2", "TARPAULIN PRINTING SERVICES"))
        self.Inventory.setText(_translate("Report_2", "Inventory"))
        self.Order.setText(_translate("Report_2", "Orders"))
        self.Purchase.setText(_translate("Report_2", "Purchases"))
        self.Report.setText(_translate("Report_2", "Reports"))
        self.Customer.setText(_translate("Report_2", "Customers"))
        self.Profile.setText(_translate("Report_2", "Profile"))
        self.ProductLabel.setText(_translate("Report_2", "Profit & Loss"))
        self.manageLabel.setText(_translate("Report_2", "Manage your profit & loss"))
        item = self.tableWidget.verticalHeaderItem(0)
        item.setText(_translate("Report_2", "Sales"))
        item = self.tableWidget.verticalHeaderItem(1)
        item.setText(_translate("Report_2", "Service"))
        item = self.tableWidget.verticalHeaderItem(2)
        item.setText(_translate("Report_2", "Gross Profit"))
        item = self.tableWidget.verticalHeaderItem(3)
        item.setText(_translate("Report_2", "Purchase"))
        item = self.tableWidget.verticalHeaderItem(4)
        item.setText(_translate("Report_2", "Total Expenses"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Report_2", "January"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Report_2", "February"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Report_2", "March"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Report_2", "April"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Report_2", "May"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("Report_2", "June"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Report_2", "July"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Report_2", "August"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("Report_2", "September"))
        item = self.tableWidget.horizontalHeaderItem(9)
        item.setText(_translate("Report_2", "October"))
        item = self.tableWidget.horizontalHeaderItem(10)
        item.setText(_translate("Report_2", "November"))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(_translate("Report_2", "December"))
import font_rc
import images_rc
...
if __name__ == "__main__":
    ...
    Report_2 = QtWidgets.QMainWindow()
    ui = Ui_Report_2()
    ui.setupUi(Report_2)
    Report_2.show()
    sys.exit(app.exec_())
